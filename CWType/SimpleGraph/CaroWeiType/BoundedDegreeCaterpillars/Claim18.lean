...
lemma Corollary2' {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] {x y v w : V} (hG : G.support ⊆ ABC.toFinset)
...
private lemma three_le_deg {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset)
    {v x : V} (hBv : ABC.B v) (hdv : G.degree v = 3) (hvx : G.Adj v x)
    (ih : ∀ (G' : SimpleGraph V) [DecidableRel G'.Adj] (ABC' : Tripartition V)
      [ABC'.Decidable], G'.support ⊆ ABC'.toFinset → ABC'.card < ABC.card → Objective G' ABC') :
...
lemma hNvw {G : SimpleGraph V} [DecidableRel G.Adj] {û v w x y : V}
...
lemma sum_hNvw {G : SimpleGraph V} [DecidableRel G.Adj] {û v w x y : V}
...
private lemma _A3 {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y : V}
...
private lemma γ_eq_zero_in_N2 {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y : V}
...
private lemma _respects {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} {û v w x y : V}
...
lemma _induces_forest {G : SimpleGraph V} [DecidableRel G.Adj] {û v w x y : V}
    (hwx : ¬G.Adj w x)
    (hNv : G.neighborFinset v = {û, w, x}) (hNw : G.neighborFinset w = {û, v, y}) :
...
lemma Claim18 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
