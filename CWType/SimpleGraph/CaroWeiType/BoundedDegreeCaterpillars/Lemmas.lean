...
lemma fC_decreasing {d d' : ℕ} (h : d ≤ d') : fC d' ≤ fC d := by
  ...
  split_ifs
  any_goals grind
  · exact (div_le_one₀ add_one_pos).mpr <| le_trans (by linarith) one_le_add_one_of_nat
  · refine (div_le_div_iff₀ add_one_pos six_pos).mpr ?_
    simp only [one_mul]
    refine @le_of_eq_of_le _ _ 4 _ _ (by linarith) ?_
...
@[simp]
lemma not_A_of_B {ABC : Tripartition V} {v : V} (hB : ABC.B v) : ¬ABC.A v :=
  fun hA ↦ ABC.sound v |>.1 ⟨hA, hB⟩

@[simp]
lemma not_A_of_C {ABC : Tripartition V} {v : V} (hC : ABC.C v) : ¬ABC.A v :=
  fun hA ↦ ABC.sound v |>.2.1 ⟨hA, hC⟩

@[simp]
lemma not_B_of_A {ABC : Tripartition V} {v : V} (hA : ABC.A v) : ¬ABC.B v :=
  fun hB ↦ ABC.sound v |>.1 ⟨hA, hB⟩

@[simp]
lemma not_B_of_C {ABC : Tripartition V} {v : V} (hC : ABC.C v) : ¬ABC.B v :=
  fun hB ↦ ABC.sound v |>.2.2 ⟨hB, hC⟩

@[simp]
lemma not_C_of_A {ABC : Tripartition V} {v : V} (hA : ABC.A v) : ¬ABC.C v :=
  fun hC ↦ ABC.sound v |>.2.1 ⟨hA, hC⟩

@[simp]
lemma not_C_of_B {ABC : Tripartition V} {v : V} (hB : ABC.B v) : ¬ABC.C v :=
...
lemma f_eq_zero_of_notMem (G : SimpleGraph V) {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hv : v ∉ ABC) :
    0 = f G ABC v := by
  simp only [Tripartition.mem_iff, not_or] at hv
  obtain ⟨hvA, hvB, hvC⟩ := hv
  simp only [f, hvA, ↓reduceDIte, hvB, hvC]

lemma γ_eq_zero_of_notMem (G : SimpleGraph V) {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hv : v ∉ ABC) :
    0 = γ G ABC v := by
  simp only [Tripartition.mem_iff, not_or] at hv
  obtain ⟨hvA, hvB, hvC⟩ := hv
...
lemma ℓ_eq_zero_of_notMem (G : SimpleGraph V) {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hv : v ∉ ABC) :
    0 = ℓ G ABC v := by
  simp only [Tripartition.mem_iff, not_or] at hv
  obtain ⟨hvA, hvB, hvC⟩ := hv
...
lemma f_congr {G G' : SimpleGraph V} {ABC ABC' : Tripartition V}
...
lemma fC_pos {d : ℕ} : 0 < fC d := by
  simp only [fC]
  split_ifs
  · exact zero_lt_one
  · linarith
  · refine div_pos_iff_of_pos_left two_thirds_pos |>.mpr add_one_pos

lemma zero_le_fC {d : ℕ} : 0 ≤ fC d :=
  le_of_lt fC_pos

lemma fB_pos {d : ℕ} : 0 < fB d :=
  lt_of_lt_of_le fC_pos fC_le_fB

lemma zero_le_fB {d : ℕ} : 0 ≤ fB d :=
  le_trans zero_le_fC fC_le_fB

lemma fA_pos {d : ℕ} : 0 < fA d :=
  lt_of_lt_of_le fC_pos fC_le_fA

lemma zero_le_fA {d : ℕ} : 0 ≤ fA d :=
  le_trans zero_le_fC fC_le_fA
...
lemma fC_le_one {d : ℕ} : fC d ≤ 1 :=
  le_trans fC_le_fA fA_le_one

lemma f_le_one {G : SimpleGraph V} {ABC : Tripartition V} {v : V} [Fintype (G.neighborSet v)] :
    f G ABC v ≤ 1 := by
  rw [f]
  split_ifs
  · exact fA_le_one
...
lemma fA2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fB2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fC2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fB3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fC3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fB4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fC4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA5 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA6 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma f_le_fA {G : SimpleGraph V} {ABC : Tripartition V}
...
lemma f_le_fB_of_not_A {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hAv : ¬ABC.A v) :
...
lemma fC_le_f {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hv : v ∈ ABC) :
    fC (G.degree v) ≤ f G ABC v  := by
  rcases hv with hA | hB | hC
  · simp only [f, hA, ↓reduceDIte, fC_le_fA]
  · simp only [f, hB, not_A_of_B, ↓reduceDIte, fC_le_fB]
  · simp only [f, hC, not_A_of_C, not_B_of_C, ↓reduceDIte, le_refl]

lemma fA_eq_deg_mul_γ_of_three_le_deg {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hAv : ABC.A v) (hdv : 3 ≤ G.degree v) :
...
lemma fB_eq_deg_mul_γ_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hBv : ABC.B v) (hdv : 4 ≤ G.degree v) :
    f G ABC v = G.degree v * γ G ABC v := by
...
lemma fC_eq_deg_mul_γ_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hCv : ABC.C v) (hdv : 4 ≤ G.degree v) :
    f G ABC v = G.degree v * γ G ABC v := by
...
lemma fA_le_13_of_5_le_deg' {d : ℕ} (h : 5 ≤ d) : fA d ≤ 1 / 3 :=
  le_of_le_of_eq (fA_decreasing h) (by grind only)

lemma fA_le_13_of_5_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : 5 ≤ G.degree v) :
    f G ABC v ≤ 1 / 3 := by
  simp only [f, hA, ↓reduceDIte]
  exact fA_le_13_of_5_le_deg' hv

lemma fA_le_25_of_4_le_deg' {d : ℕ} (h : 4 ≤ d) : fA d ≤ 2 / 5 :=
  le_of_le_of_eq (fA_decreasing h) (by grind only)

lemma fA_le_25_of_4_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : 4 ≤ G.degree v) :
    f G ABC v ≤ 2 / 5 := by
  simp only [f, hA, ↓reduceDIte]
  exact fA_le_25_of_4_le_deg' hv

lemma fA_le_12_of_3_le_deg' {d : ℕ} (h : 3 ≤ d) : fA d ≤ 1 / 2 :=
  le_of_le_of_eq (fA_decreasing h) (by grind only)

lemma fA_le_12_of_3_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA_le_23_of_2_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fA_le_56_of_1_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : 1 ≤ G.degree v) :
    f G ABC v ≤ 5 / 6 := by
  simp only [f, hA, ↓reduceDIte]
  exact fA_le_56_of_1_le_deg' hv

lemma fB_le_13_if_2_le_deg' {d : ℕ} (h : 2 ≤ d) : fB d ≤ 1 / 3 :=
  le_trans (fB_decreasing h) (by grind only)

lemma fB_le_13_if_2_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hB : ABC.B v) (hv : 2 ≤ G.degree v) :
    f G ABC v ≤ 1 / 3 := by
  simp only [f, hB, not_A_of_B, ↓reduceDIte]
  exact fB_le_13_if_2_le_deg' hv

lemma fB_le_56_if_1_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma fC_le_16_if_2_le_deg' {d : ℕ} (h : 2 ≤ d) : fC d ≤ 1 / 6 :=
  le_trans (fC_decreasing h) (by grind only)

lemma fC_le_16_if_2_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : 2 ≤ G.degree v) :
    f G ABC v ≤ 1 / 6 := by
  simp only [f, hC, not_A_of_C, ↓reduceDIte, not_B_of_C]
  exact fC_le_16_if_2_le_deg' hv

lemma fC_le_16_if_1_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma f_le_1_over_2_of_3_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma f_le_1_over_3_of_4_le_deg_of_notA4 {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)]
...
lemma f_le_2_over_5_of_4_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hdv : 4 ≤ G.degree v) :
    f G ABC v ≤ 2 / 5 := by
  have hfA4 : fA 4 = 2 / 5 := by lia
  refine le_trans f_le_fA (hfA4 ▸ fA_decreasing hdv)

lemma A2_of_f_lt_12_of_2_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma f_le_1_over_3_of_4_le_deg_of_not_A4 {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)]
  ...
  if hvABC : v ∈ ABC then
    ...
    rw [← f_eq_zero_of_notMem _ hvABC]
    linarith

lemma A2_or_A3_of_f_lt_25_of_2_le_deg {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)]
...
lemma γA_eq_of_three_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB_eq_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γC_eq_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_le_γA_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hdv : 4 ≤ G.degree v) :
...
lemma γA1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 1) :
    γ G ABC v = 1 / 6 := by
  simp only [γ, hA, ↓reduceDIte, fA, hv, tsub_self, ↓reduceIte, one_ne_zero, one_div]
  linarith

lemma γA2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 2) :
    γ G ABC v = 1 / 6 := by
...
lemma γA3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 3) :
    γ G ABC v = 1 / 6 := by
  rw [γA_eq_of_three_le_deg hA (le_of_eq hv.symm), hv]
  linarith

lemma γA4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 4) :
    γ G ABC v = 1 / 10 := by
  rw [γA_eq_of_three_le_deg hA (by lia), hv]
  linarith

lemma γA5 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 5) :
    γ G ABC v = 1 / 15 := by
  rw [γA_eq_of_three_le_deg hA (by lia), hv]
  linarith

lemma γA6 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 6) :
    γ G ABC v = 1 / 21 := by
  rw [γA_eq_of_three_le_deg hA (by lia), hv]
  linarith

lemma γA7 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 7) :
    γ G ABC v = 1 / 28 := by
  rw [γA_eq_of_three_le_deg hA (by lia), hv]
  linarith

lemma γA8 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γA_decreasing_of_three_le_degree {d d' : ℕ} (hdd' : d ≤ d') (hd : 3 ≤ d) :
  ...
  simp only [fA]
  have hd0 : d ≠ 0 := Nat.ne_zero_of_lt hd
  have hd'0 : d' ≠ 0 := Nat.ne_zero_of_lt (hd.trans hdd')
  have hd1 : d ≠ 1 := by linarith
  have hd'1 : d' ≠ 1 := by linarith
  have hd1' : d - 1 ≠ 0 := Nat.sub_ne_zero_of_lt <| Nat.lt_of_add_left_lt hd
  have hd'1' : d' - 1 ≠ 0 := Nat.sub_ne_zero_of_lt <| Nat.lt_of_add_left_lt (hd.trans hdd')
  have hd2 : d ≠ 2 := Ne.symm <| Nat.ne_of_lt hd
  have hd'2 : d' ≠ 2 := Ne.symm <| Nat.ne_of_lt (hd.trans hdd')
  ...
  · refine Left.mul_pos ?_ add_one_pos
    rw [← Nat.cast_zero, Nat.cast_lt]
    exact Nat.zero_lt_of_ne_zero hd'0
  · refine Left.mul_pos ?_ add_one_pos
    rw [← Nat.cast_zero, Nat.cast_lt]
    exact Nat.zero_lt_of_ne_zero hd0
  · simp only [Nat.ofNat_pos, mul_le_mul_iff_right₀]
    ...
    refine Nat.mul_le_mul hdd' <| add_le_add hdd' (le_refl _)

lemma γA_le_1_10_of_4_le_degree {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB_decreasing_of_four_le_degree {d d' : ℕ} (hdd' : d ≤ d') (hd : 4 ≤ d) :
  ...
  have hd1' : d - 1 ≠ 0 := Nat.sub_ne_zero_of_lt <| Nat.lt_of_add_left_lt hd
  have hd'1' : d' - 1 ≠ 0 := Nat.sub_ne_zero_of_lt <| Nat.lt_of_add_left_lt (hd.trans hdd')
  have hd2 : d ≠ 2 := Ne.symm <| Nat.ne_of_lt <| Nat.lt_of_add_left_lt hd
  have hd'2 : d' ≠ 2 := Ne.symm <| Nat.ne_of_lt <| Nat.lt_of_add_left_lt (hd.trans hdd')
  have hd3 : d ≠ 3 := Ne.symm <| Nat.ne_of_lt hd
  have hd'3 : d' ≠ 3 := Ne.symm <| Nat.ne_of_lt (hd.trans hdd')
  simp only [ ↓reduceIte, Nat.pred_eq_succ_iff, zero_add, ge_iff_le,
...
lemma γB_le_1_15_of_4_le_degree {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γC1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : G.degree v = 1) :
    γ G ABC v = 5 / 6 := by
...
lemma γC2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : G.degree v = 2) :
    γ G ABC v = 0 := by
...
lemma γC3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γC_le_1_30_of_4_le_degree {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_le_γA_of_three_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_le_γB_of_three_le_deg_of_notA {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hdv : 3 ≤ G.degree v) (hA : ¬ABC.A v) :
...
lemma γ_le_1_over_6_of_3_le_degree {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hdv : 3 ≤ G.degree v) :
    γ G ABC v ≤ 1 / 6 := by
  if hv : v ∈ ABC then
...
lemma γ_le_1_10_of_4_le_degree {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hdv : 4 ≤ G.degree v) :
    γ G ABC v ≤ 1 / 10 := by
  if hv : v ∈ ABC then
...
lemma γ_le_1_over_10_of_3_le_degree_of_not_A3 {G : SimpleGraph V}
    {ABC : Tripartition V} {v : V} [Fintype (G.neighborSet v)]
...
lemma γA_pos_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γB_pos_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hBv : ABC.B v) (hdv : 4 ≤ G.degree v) :
    0 < γ G ABC v := by
...
lemma γC_pos_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hCv : ABC.C v) (hdv : 4 ≤ G.degree v) :
    0 < γ G ABC v := by
...
lemma γ_pos_of_four_le_deg {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_eq_0_of_degree_eq_0 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma A_or_γ_eq_0_of_deg_eq_3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_eq_0_iff {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma f_le_1_over_3_of_γ_eq_0 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma γ_eq_zero_of_deg_eq_zero {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hdv : G.degree v = 0) : γ G ABC v = 0 := by
  simp only [γ, fA, hdv, zero_tsub, ↓reduceIte, sub_self, fB, fC, dite_eq_ite, ite_self]

lemma if_γ_gt_one_over_six {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
...
lemma ℓA1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 1) :
    ℓ G ABC v = 1 / 6 := by
...
lemma ℓA2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 2) :
    ℓ G ABC v = 1 / 6 := by
...
lemma ℓA3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 3) :
    ℓ G ABC v = 1 / 10 := by
...
lemma ℓA4 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hA : ABC.A v) (hv : G.degree v = 4) :
    ℓ G ABC v = 1 / 15 := by
  simp only [ℓ, hA, ↓reduceDIte, ↓reduceIte, fA, hv, Nat.reduceAdd, OfNat.ofNat_ne_zero,
    OfNat.ofNat_ne_one, Nat.cast_ofNat]
...
lemma ℓB1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hB : ABC.B v) (hv : G.degree v = 1) :
    ℓ G ABC v = 1 / 2 := by
...
lemma ℓB2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hB : ABC.B v) (hv : G.degree v = 2) :
    ℓ G ABC v = 0 := by
...
lemma ℓB3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hB : ABC.B v) (hv : G.degree v = 3) :
    ℓ G ABC v = 1 / 15 := by
...
lemma ℓC1 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : G.degree v = 1) :
    ℓ G ABC v = 0 := by
...
lemma ℓC2 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : G.degree v = 2) :
    ℓ G ABC v = 0 := by
...
lemma ℓC3 {G : SimpleGraph V} {ABC : Tripartition V} {v : V}
    [Fintype (G.neighborSet v)] (hC : ABC.C v) (hv : G.degree v = 3) :
    ℓ G ABC v = 1 / 30 := by
  simp only [ℓ, hC, not_A_of_C, ↓reduceDIte, not_B_of_C, fC, hv, OfNat.ofNat_ne_zero, ↓reduceIte,
...
lemma ℓ_le_1_over_10_of_3_le_degree {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (h : 3 ≤ G.degree v) :
    ℓ G ABC v ≤ 1 / 10 := by
...
lemma ℓ_le_1_over_15_of_4_le_degree {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (h : 4 ≤ G.degree v) :
    ℓ G ABC v ≤ 1 / 15 := by
  simp only [ℓ, fA, Nat.add_eq_zero_iff, one_ne_zero, and_false, ↓reduceIte, Nat.add_eq_right,
    Nat.cast_add, Nat.cast_one, fB, Nat.reduceEqDiff, fC, dite_eq_ite]
...
lemma ℓ_le_1_over_15_of_3_le_degree_of_notA3 {G : SimpleGraph V}
    {ABC : Tripartition V} {v : V} [Fintype (G.neighborSet v)]
...
lemma Δf_le_ℓ_of_Δdeg_le_1 {G G' : SimpleGraph V} {ABC ABC' : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] [Fintype (G'.neighborSet v)]
...
@[simp]
lemma demote_finset_from_A (ABC : Tripartition V) {v : V} (hAv : ABC.A v)
    {s : Finset _} (hv : v ∈ s) : (ABC.demote_finset s).B v := by
  exact Or.inr ⟨hAv, hv⟩

@[simp]
lemma demote_finset_from_B (ABC : Tripartition V) {v : V} (hBv : ABC.B v)
    {s : Finset _} (hv : v ∈ s) : (ABC.demote_finset s).C v := by
  exact Or.inr ⟨hBv, hv⟩

@[simp]
lemma demote_finset_from_C (ABC : Tripartition V) {v : V} (hCv : ABC.C v)
    {s : Finset _} : (ABC.demote_finset s).C v := by
  exact Or.inl hCv

@[simp]
lemma demote_from_A (ABC : Tripartition V) {v : V} (hAv : ABC.A v) :
    (ABC.demote v).B v := by
...
@[simp]
lemma demote_from_B (ABC : Tripartition V) {v : V} (hBv : ABC.B v) :
    (ABC.demote v).C v := by
  exact demote_finset_from_B _  hBv (mem_singleton.mpr rfl)

@[simp]
lemma demote_from_B' (ABC : Tripartition V) {v : V} (hv : ABC.B v) :
    ¬(ABC.demote v).B v := by
  exact not_B_of_C <| demote_from_B ABC hv

@[simp]
lemma demote_from_C (ABC : Tripartition V) {v : V} (hv : ABC.C v) :
    (ABC.demote v).C v := by
  exact Or.inl hv

@[simp]
lemma A_of_demote_finset_notin (ABC : Tripartition V) {v : V} {s : Finset _}
    (hv : v ∉ s) : ABC.A v → (ABC.demote_finset s).A v := by
  exact fun hA ↦ ⟨hA, hv⟩

@[simp]
lemma B_of_demote_finset_notin (ABC : Tripartition V) {v : V} {s : Finset _}
    (hv : v ∉ s) : ABC.B v → (ABC.demote_finset s).B v := by
  exact fun hB ↦ Or.inl ⟨hB, hv⟩

@[simp]
lemma C_of_demote_finset_notin (ABC : Tripartition V) {v : V} {s : Finset _} :
    ABC.C v → (ABC.demote_finset s).C v := by
  exact fun hC ↦ Or.inl hC

@[simp]
lemma A_of_demote_ne (ABC : Tripartition V) {v w : V} (h : v ≠ w) :
    ABC.A v → (ABC.demote w).A v := by
  exact fun hA ↦ ABC.A_of_demote_finset_notin (not_iff_not.mpr mem_singleton |>.mpr h) hA

@[simp]
lemma B_of_demote_ne (ABC : Tripartition V) {v w : V} (h : v ≠ w) :
    ABC.B v → (ABC.demote w).B v := by
  exact fun hB ↦ ABC.B_of_demote_finset_notin (not_iff_not.mpr mem_singleton |>.mpr h) hB

@[simp]
lemma C_of_demote_ne (ABC : Tripartition V) {v w : V} :
    ABC.C v → (ABC.demote w).C v := by
  exact fun hC ↦ ABC.C_of_demote_finset_notin hC

lemma mem_promote_finset_of_mem (ABC : Tripartition V) {x : V} {s : Finset _} :
...
lemma mem_promote_of_mem (ABC : Tripartition V) {x y : V} :
    x ∈ ABC → x ∈ ABC.promote y := by
  intro h
  simp only [promote]
  exact ABC.mem_promote_finset_of_mem h

lemma mem_of_mem_promote_finset (ABC : Tripartition V) {x : V} {s : Finset _} :
...
lemma mem_of_mem_promote (ABC : Tripartition V) {x y : V} :
...
@[simp]
lemma mem_iff_mem_demote (ABC : Tripartition V) {x y : V} :
    x ∈ ABC ↔ x ∈ ABC.demote y :=
  ⟨ABC.mem_demote_of_mem, ABC.mem_of_mem_demote⟩

@[simp]
lemma mem_iff_mem_demote_tofinset (ABC : Tripartition V) {x : V} {s : Finset _} :
    x ∈ ABC ↔ x ∈ ABC.demote_finset s :=
  ⟨ABC.mem_demote_finset_of_mem, ABC.mem_of_mem_demote_finset⟩

lemma promote_from_A (ABC : Tripartition V) (v : V) (hv : ABC.A v) :
    (ABC.promote v).A v := by
  simp only [promote, promote_finset, hv, not_B_of_A, true_or]

lemma promote_from_B (ABC : Tripartition V) (v : V) (hv : ABC.B v) :
    (ABC.promote v).A v := by
...
lemma promote_from_C (ABC : Tripartition V) (v : V) (hv : ABC.C v) :
    (ABC.promote v).B v := by
...
@[simp]
lemma card_demote_finset_eq_card [DecidableEq V] {ABC : Tripartition V} [ABC.Decidable]
    {s : Finset _} :
...
@[simp]
lemma card_demote_eq_card [DecidableEq V] {ABC : Tripartition V} [ABC.Decidable] {x : V} :
    ABC.card = (ABC.demote x).card := by
  simp only [card]
  rw [demote_toFinset_eq]

@[simp]
lemma card_promote_eq_card [DecidableEq V] {ABC : Tripartition V} [ABC.Decidable] {x : V} :
    ABC.card = (ABC.promote x).card := by
  simp only [card]
  rw [promote_toFinset_eq]

@[simp]
lemma sdiff_notMem (ABC : Tripartition V) (s : Finset V) :
    ∀ x ∈ s, x ∉ ABC \ s := by
  intro x hx
  simp [sdiff, hx]

@[simp]
lemma sdiff_mem (ABC : Tripartition V) (s : Finset V) :
...
@[simp]
lemma mem_sdiff_iff (ABC : Tripartition V) (s : Finset V) {x : V} :
...
@[simp]
lemma toFinset_mono [DecidableEq V] {ABC : Tripartition V} [ABC.Decidable] {s : Finset V} :
...
lemma sdiff_card [DecidableEq V] (ABC : Tripartition V) [ABC.Decidable] {s : Finset V}
...
lemma sdiff_toFinset [DecidableEq V] (ABC : Tripartition V) [ABC.Decidable] {s : Finset V} :
    (ABC \ s).toFinset = ABC.toFinset \ s := by
  ext y
  simp only [toFinset, toSet, sdiff, mem_iff, and_or_3, Set.mem_toFinset, Set.mem_setOf_eq,
    Set.toFinset_setOf, mem_sdiff, mem_filter, mem_univ, true_and]

lemma linear_forest_of_forest_respects [DecidableEq V] {s : Finset V} {G : SimpleGraph V}
    [DecidableRel G.Adj] {ABC : Tripartition V} [ABC.Decidable] (hs : s ⊆ ABC.toFinset) :
...
lemma respects_singleton [DecidableEq V] {G : SimpleGraph V} [G.LocallyFinite]
    {ABC : Tripartition V} {v : V} :
    respects {v} G ABC := by
...
lemma respects_pair_of_non_adj [DecidableEq V] {G : SimpleGraph V} [G.LocallyFinite]
    {ABC : Tripartition V} {v w : V} (hvw : ¬G.Adj v w) : respects {v, w} G ABC := by
  intro u hu
...
lemma respects_pair_of_Bs [DecidableEq V] {G : SimpleGraph V} [G.LocallyFinite]
    {ABC : Tripartition V} {v w : V} (hBv : ABC.B v) (hBw : ABC.B w) :
...
lemma respects_union [DecidableEq V] {s t : Finset V} {G : SimpleGraph V} [G.LocallyFinite]
    {ABC : Tripartition V} (hs : respects s G ABC) (ht : respects t G ABC)
...
lemma respects_mono [DecidableEq V] {s t : Finset V} (G : SimpleGraph V) [DecidableRel G.Adj]
    (ABC : Tripartition V) [ABC.Decidable] (hs : s ⊆ (ABC \ t).toFinset)
    (hresp : respects s (G.deleteIncidencesOf t) (ABC \ t)) :
    respects s G ABC := by
  intro w hw
  have mem_s_implies_notMem_t {z : V} : z ∈ s → z ∉ t := by
    intro hz
...
lemma f_le_56 (G : SimpleGraph V) (ABC : Tripartition V)
    {v : V} [Fintype (G.neighborSet v)] (hv : 0 < G.degree v) :
    f G ABC v ≤ 5 / (6 : ℝ) :=
  le_trans f_le_fA (fA_le_56_of_1_le_deg' hv)

lemma f_le_two_fifths_of_γ_lt_one_sixth {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hdv : 0 < G.degree v) (hγv : γ G ABC v < 1 / 6) :
    f G ABC v ≤ 2 / 5 := by
  if hvABC : v ∈ ABC then
    rcases hvABC with hA | hB | hC
    · simp only [f, hA, ↓reduceDIte]
...
lemma f_le_two_ninths_of_γ_lt_one_thirtieth {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hdv : 4 ≤ G.degree v) (hγv : γ G ABC v < 1 / 30) :
    f G ABC v ≤ 2 / 9 := by
  if hvABC : v ∈ ABC then
    rcases hvABC with hA | hB | hC
    · simp only [f, hA, ↓reduceDIte]
...
lemma A4_of_13_lt_f_of_γ_lt_16 {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] (hv : 1 ≤ G.degree v) (h : v ∈ ABC)
...
lemma f_le_two_sevenths_of_γ_lt_one_fifteenth_of_γ_ne_zero {G : SimpleGraph V}
    {ABC : Tripartition V} {v : V} [Fintype (G.neighborSet v)]
...
lemma f_congr_degree (G₁ G₂ : SimpleGraph V) (ABC : Tripartition V)
    {v : V} [Fintype (G₁.neighborSet v)] [Fintype (G₂.neighborSet v)] :
    G₁.degree v = G₂.degree v → f G₁ ABC v = f G₂ ABC v := by
  intro heq
  simp only [f, fA, fB, one_div, fC, dite_eq_ite, heq]

lemma f_eq_in_sdiff (G : SimpleGraph V) (ABC : Tripartition V)
    {s : Finset V} {w : V} [Fintype (G.neighborSet w)] (hw : w ∉ s) :
    f G (ABC \ s) w = f G ABC w := by
  have hAiff : ABC.A w ↔ (ABC \ s).A w := ⟨fun h ↦ ⟨h, hw⟩, fun ⟨h, _⟩ ↦ h⟩
  have hBiff : ABC.B w ↔ (ABC \ s).B w := ⟨fun h ↦ ⟨h, hw⟩, fun ⟨h, _⟩ ↦ h⟩
  have hCiff : ABC.C w ↔ (ABC \ s).C w := ⟨fun h ↦ ⟨h, hw⟩, fun ⟨h, _⟩ ↦ h⟩
  if hw : w ∈ ABC then
    rcases hw with hA | hB | hC
    · simp only [f, hA, hAiff.mp, ↓reduceDIte]
    · simp only [f, hB, hBiff.mp, not_A_of_B, ↓reduceDIte]
    · simp only [f, hC, hCiff.mp, not_A_of_C, not_B_of_C, ↓reduceDIte]
  else
    have hw' : w ∉ (ABC \ s) := by grind only [Tripartition.mem_iff]
    rw [← f_eq_zero_of_notMem _ hw, ← f_eq_zero_of_notMem _ hw']

lemma f_pos_of_mem (G : SimpleGraph V) (ABC : Tripartition V)
    (v : V) [Fintype (G.neighborSet v)] : v ∈ ABC → 0 < f G ABC v :=
  (lt_of_lt_of_le fC_pos <| fC_le_f ·)

lemma f_mono {G₁ G₂ : SimpleGraph V} {ABC : Tripartition V}
...
@[simp, grind! .]
lemma γ_nonneg {G : SimpleGraph V} {ABC : Tripartition V}
    {v : V} [Fintype (G.neighborSet v)] : 0 ≤ γ G ABC v := by
...
lemma f_eq_sdiff {G : SimpleGraph V} {ABC : Tripartition V}
...
private lemma eval_mono (G₁ G₂ : SimpleGraph V) (hle : G₁ ≤ G₂)
    [G₁.LocallyFinite] [G₂.LocallyFinite] (ABC : Tripartition V) [ABC.Decidable] :
...
lemma eval_lt [DecidableEq V] (G : SimpleGraph V) [G.LocallyFinite]
    (ABC : Tripartition V) [ABC.Decidable] (W : Finset V) (hW : W ∩ ABC.toFinset ≠ ∅) :
  ...
  calc ∑ v ∈ (ABC \ W).toFinset, f G (ABC \ W) v
    ...
    _ = ∑ v ∈ ABC.toFinset, f G ABC v := by
      have _ {s t : Finset V} : s ∩ t = t ∩ s := inter_comm s t
...
lemma f_deleteIncidencesOf_isolated (ABC : Tripartition V) (G : SimpleGraph V)
    {v w : V} [Fintype (G.neighborSet v)] [Fintype (G.neighborSet w)]
...
lemma hsupp_mono [DecidableEq V] {G : SimpleGraph V} {ABC : Tripartition V} [ABC.Decidable]
...
lemma one_le_deg_of_vstar {G : SimpleGraph V} [G.LocallyFinite] {ABC : Tripartition V}
    [ABC.Decidable] {v : V} (hv : IsVstar G ABC v) :
    1 ≤ G.degree v := by
  by_contra
...
lemma mem_ABC_of_vstar {G : SimpleGraph V} [G.LocallyFinite] {ABC : Tripartition V}
    [ABC.Decidable] {v : V} (hv : IsVstar G ABC v) : v ∈ ABC :=
  ABC.mem_toFinset.mpr hv.1.1

lemma γ_ne_zero_of_vstar {G : SimpleGraph V} [G.LocallyFinite] {ABC : Tripartition V}
    [ABC.Decidable] {v : V} (hv : IsVstar G ABC v) : γ G ABC v ≠ 0 :=
  hv.1.2

lemma γ_vstar_le_γ {G : SimpleGraph V} [G.LocallyFinite] {ABC : Tripartition V}
    [ABC.Decidable] {u v : V} (hv : IsVstar G ABC v) (hu : u ∈ ABC) (hγu : γ G ABC u ≠ 0) :
...
lemma ne_B3_of_vstar {G : SimpleGraph V} [G.LocallyFinite] {ABC : Tripartition V}
    [ABC.Decidable] {v : V} (hv : IsVstar G ABC v) :
    ¬(ABC.B v ∧ G.degree v = 3) :=
  fun h ↦ γ_ne_zero_of_vstar hv
    <| γ_eq_0_iff (mem_ABC_of_vstar hv) (one_le_deg_of_vstar hv) |>.mpr <| Or.inl h.symm

lemma ne_C3_of_vstar {G : SimpleGraph V} {ABC : Tripartition V} [G.LocallyFinite]
    [ABC.Decidable] {v : V} (hv : IsVstar G ABC v) :
