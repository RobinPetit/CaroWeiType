...
private lemma _A4 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {u : V} (hdu : 2 ≤ G.degree u)
...
private lemma Corollary2' {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] {u v w : V} (hG : G.support ⊆ ABC.toFinset)
...
private lemma Corollary2'' {G : SimpleGraph V} [DecidableRel G.Adj]
    {ABC : Tripartition V} [ABC.Decidable] {û v w x y s t : V}
...
private lemma _step1 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    {u v w : V}
...
private lemma _step2 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    ...
    {v w : V} (hCv : ABC.C v) (hdv : G.degree v = 3) (hCw : ABC.C w) (hdw : G.degree w = 3)
    (ih : ∀ (G' : SimpleGraph V) [DecidableRel G'.Adj] (ABC' : Tripartition V)
      [ABC'.Decidable], G'.support ⊆ ABC'.toFinset → ABC'.card < ABC.card → Objective G' ABC') :
...
private lemma _step3 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
...
private lemma _step4 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {v w : V}
    (hCv : ABC.C v) (hdv : G.degree v = 3) (hCw : ABC.C w) (hdw : G.degree w = 3)
    (ih : ∀ (G' : SimpleGraph V) [DecidableRel G'.Adj] (ABC' : Tripartition V)
      [ABC'.Decidable], G'.support ⊆ ABC'.toFinset → ABC'.card < ABC.card → Objective G' ABC') :
...
private lemma _step5 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y s t : V}
    (hfû : f G ABC û ≤ 2 / 7)
    (hCv : ABC.C v) (hdv : G.degree v = 3) (hCw : ABC.C w) (hdw : G.degree w = 3)
    (hv : G.Adj û v) (hw : G.Adj û w) (hvw : ¬G.Adj v w) (hvnew : v ≠ w)
...
private lemma _step6 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y : V}
...
private lemma _step7 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y : V} (hû : IsVstar G ABC û)
...
private lemma _step8 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v x y : V}
    (hAx : ABC.A x) (hdx : G.degree x = 4) (hCv : ABC.C v) (hdv : G.degree v = 3)
    (hv : G.Adj û v) (hNv : G.neighborFinset v = {û, x, y})
    (ih : ∀ (G' : SimpleGraph V) [DecidableRel G'.Adj] (ABC' : Tripartition V)
      [ABC'.Decidable], G'.support ⊆ ABC'.toFinset → ABC'.card < ABC.card → Objective G' ABC') :
...
private lemma _step9 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
    [ABC.Decidable] (hG : G.support ⊆ ABC.toFinset) {û v w x y s t : V}
    (hCv : ABC.C v) (hdv : G.degree v = 3) (hCw : ABC.C w) (hdw : G.degree w = 3)
...
lemma Claim17 {G : SimpleGraph V} [DecidableRel G.Adj] {ABC : Tripartition V}
